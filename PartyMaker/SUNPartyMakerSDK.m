...
-(void) partyWithId:(NSString *) creatorId callback:(void (^) (NSDictionary *response, NSError *error))block{
    
    NSURLRequest * request = [self request:@"GET" withMethod:@"/party" headers:nil parameters:@{@"creator_id": creatorId}];
...
-(void) addPartyWithId:(NSString *) partyId name:(NSString *) name startTime:(NSString *) startTime endTime:(NSString *) endTime logoId:(NSString *) logoNumber comment:(NSString *) partyDiscription creatorId:(NSString *) creatorId latitude:(NSString *) latitude longitude:(NSString *) longitude callback:(void (^) (NSDictionary *response, NSError *error))block{
    ...
    NSURLRequest * request = [self request:@"POST" withMethod:@"/addParty" headers:nil parameters:@{@"party_id": partyId, @"name": name, @"start_time": startTime, @"end_time": endTime, @"logo_id": logoNumber, @"comment": partyDiscription, @"creator_id": creatorId, @"latitude": latitude, @"longitude": longitude}];
